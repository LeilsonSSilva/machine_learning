...
#outro modelo de treino: modelotree=DecisionTreeRegressor(random_state=1,min_samples_leaf=15)

# modelotree.fit(X,y)
# predicaotree=modelotree.predict(X)
# mean_absolute_error(y,predicaotree)

# print(mean_absolute_error(y,predicaotree))
...
# print(mean_absolute_error(val_y,predicao))
